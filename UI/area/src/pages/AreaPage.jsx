    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-purple-50 px-6 py-12">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl font-bold text-gray-800 mb-2">Create Automation</h1>
            <p className="text-gray-600">Build workflows by connecting actions and reactions</p>
          </div>
          <div className="flex gap-3">
            <button
              onClick={() => navigate("/services")}
              className="px-5 py-2 bg-white border-2 border-indigo-500 text-indigo-600 rounded-lg hover:bg-indigo-50 transition"
            >
              Manage Services
            </button>
            <button
              onClick={() => navigate("/applets")}
              className="px-5 py-2 bg-white border-2 border-purple-500 text-purple-600 rounded-lg hover:bg-purple-50 transition flex items-center gap-2"
            >
              <FaCog /> My Applets
            </button>
          </div>
        ...
        {!hasRequiredServices ? (
          <div className="bg-white p-12 rounded-xl shadow text-center">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Connect Services First</h2>
            <p className="text-gray-600 mb-6">
              To create an AREA, you need at least one service with <strong className="text-indigo-600">actions</strong> (like Timer)
              and one service with <strong className="text-purple-600">reactions</strong> (like Mail).
            </p>
            <div className="flex justify-center gap-4 mb-6">
              <div className="flex items-center gap-2">
                <FaPlay className="text-indigo-500" />
                <span className="text-gray-700">Actions: {actionServices.length}</span>
              </div>
              <div className="flex items-center gap-2">
                <FaBolt className="text-purple-500" />
                <span className="text-gray-700">Reactions: {reactionServices.length}</span>
              </div>
            </div>
            <button
              onClick={() => navigate("/services")}
              className="px-8 py-3 bg-gradient-to-r from-sky-500 to-indigo-500 text-white rounded-lg text-lg font-semibold hover:opacity-90 transition"
            >
              Go to Services
            </button>
          </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="space-y-2">
                  {actionServices.map(service => (
                    <div key={service.name} className="flex items-center gap-2">
                      <span className="font-medium capitalize text-gray-700">{service.name}:</span>
              ...
              <div className="bg-white p-6 rounded-xl shadow border-l-4 border-purple-500">
                <div className="flex items-center gap-2 mb-3">
                  <FaBolt className="text-purple-500" />
                  <h3 className="text-lg font-semibold text-gray-800">Available Reactions</h3>
                </div>
                <div className="space-y-2">
            ...
            <div className="text-center">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white rounded-xl text-xl font-semibold hover:opacity-90 transition flex items-center gap-3 mx-auto"
              >
        ...
        {/* Create AREA Modal */}
        {showCreateModal && (
          <div className="fixed inset-0 bg-black/40 flex items-center justify-center overflow-auto z-50 p-4">
            <div className="bg-white p-6 rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-y-auto">
              <h3 className="text-2xl font-bold mb-4">Create New AREA</h3>
              ...
              <label className="block mb-4">
                ...
                <input
                  ...
                  className="mt-1 w-full p-3 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                />
              </label>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="border-r pr-4">
                  ...
                  <label className="block mb-3">
                    ...
                    <select
                      className="mt-1 w-full p-2 border rounded-lg capitalize"
                    ...
                    <>
                      ...
                      {selectedAction?.name === "time_at" && (
                        <div className="mt-4 p-3 bg-indigo-50 rounded-lg border border-indigo-200">
                          <p className="text-sm font-semibold mb-2 text-indigo-700">Configure Time</p>
                          <label className="block">
                            <span className="text-xs text-gray-600">Time (HH:mm)</span>
                            <input
                              type="time"
                      ...
                      {(selectedAction?.name === "new_push" || selectedAction?.name === "new_issue") && (
                        <div className="mt-4 p-3 bg-indigo-50 rounded-lg border border-indigo-200 space-y-2">
                          <p className="text-sm font-semibold mb-2 text-indigo-700">Configure Repository</p>
                          <label className="block">
                            <span className="text-xs text-gray-600">Repository Owner</span>
                            <input
                              type="text"
                          ...
                          <label className="block">
                            <span className="text-xs text-gray-600">Repository Name</span>
                            <input
                              type="text"
                ...
                {/* Reaction Column */}
                <div className="pl-4">
                  <h4 className="font-bold text-lg mb-3 text-purple-600 flex items-center gap-2">
                  ...
                  {selectedReactionService && (
                    <>
                      <label className="block mb-3">
                        <span className="font-semibold text-sm">Reaction</span>
                        <select
                          className="mt-1 w-full p-2 border rounded-lg"
                        ...
                        {selectedReaction?.description && (
                          <p className="text-xs text-gray-500 mt-1">{selectedReaction.description}</p>
                        )}
                      </label>
                      ...
                      {selectedReaction?.name === "send_email" && (
                        <div className="mt-4 p-3 bg-purple-50 rounded-lg border border-purple-200 space-y-2">
                          <p className="text-sm font-semibold mb-2 text-purple-700">Configure Email</p>
                          <label className="block">
                      ...
                      {selectedReaction?.name === "create_issue" && (
                        <div className="mt-4 p-3 bg-purple-50 rounded-lg border border-purple-200 space-y-2">
                          <p className="text-sm font-semibold mb-2 text-purple-700">Create Issue</p>
                          <label className="block">
                            <span className="text-xs text-gray-600">Repository Owner</span>
                            <input
                              type="text"
                          ...
                          <label className="block">
                            <span className="text-xs text-gray-600">Issue Title</span>
                            <input
                              type="text"
                          ...
                          <label className="block">
                            <span className="text-xs text-gray-600">Issue Body</span>
                            <textarea
                              value={reactionConfig.body || ""}
                              onChange={(e) => setReactionConfig({ ...reactionConfig, body: e.target.value })}
                      ...
                      {selectedReaction?.name === "create_comment" && (
                        <div className="mt-4 p-3 bg-purple-50 rounded-lg border border-purple-200 space-y-2">
                          <p className="text-sm font-semibold mb-2 text-purple-700">Add Comment to Issue</p>
                          <label className="block">
                            <span className="text-xs text-gray-600">Repository Owner</span>
                            <input
                              type="text"
